...
We also encourage users to <span class="highlight">carefully set up their ID column</span> as this will ease the process of aggregating the annotations with external metadata for downstream analysis.
