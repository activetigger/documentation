...
- The menu displays all topic models associated with the current project (and user ??? XXX). Each model can be deleted with the <a class="icon">![](../img/icons/delete.svg)</a>. Clicking "Compute new BERTopic" opens a modal with a form to create a new topic model with the following parameters :
