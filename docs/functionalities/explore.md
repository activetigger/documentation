...
- <span class="action primary">Convert to scheme</span> to create a [scheme](../theoretical-concepts/glossary.md#schemes) and assign labels using the topics generated. ⚠️ Note: topic-generated labels should be used with caution and carefully reviewed, since they are not based on human annotation.
